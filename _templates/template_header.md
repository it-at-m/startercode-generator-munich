...
With this repo you get starter code for **all CSV data sets** (currently {{ DATASET_COUNT }}) that are available in the [open data portal of the city of Munich](https://opendata.muenchen.de/). 
